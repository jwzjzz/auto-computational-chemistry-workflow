...
if __name__ == "__main__":
    input_json = Path("/Users/jzz/jzz_python/z_jupyter/1_jf/z_wf_instance/2_adsorp/outputs/fixadscmhf_12128.json")

    # 提取工作流信息
    project_name, db_id = extract_info_from_json(input_json)
    ssh_alias = "cm" #extract_ssh_alias_from_project(project_name)
