...
from jf_jzz import (
    VASPWorkflowBuilder,add_metadata_to_flow,WorkflowSubmitter,to_mermaid,VASPConfigManager,
    BaseVaspMaker,RelaxMaker,StaticMaker)
from atomate2.vasp.flows import *
...
def run_workflow_from_config():
    ...
    try:
        ...
        elif maker_config.get('class') == BandStructureMaker.__name__:
            custom_maker = BandStructureMaker()
            builder = VASPWorkflowBuilder(custom_maker)
            my_flow = builder.build_workflow(
        ...
        elif maker_config.get('class') == HSEBandStructureMaker.__name__:
            custom_maker = HSEBandStructureMaker()
            builder = VASPWorkflowBuilder(custom_maker)
            my_flow = builder.build_workflow(
                input_data=config["input_data"],
                base_incar=base_incar,
        ...
        elif maker_config.get('class') == HSELineModeBandStructureMaker.__name__:
            custom_maker = HSELineModeBandStructureMaker()
            builder = VASPWorkflowBuilder(custom_maker)
            my_flow = builder.build_workflow(
                input_data=config["input_data"],
                base_incar=base_incar,
        ...
        elif maker_config.get('class') == HSEOpticsMaker.__name__:
            custom_maker = HSEOpticsMaker()
            builder = VASPWorkflowBuilder(custom_maker)
            my_flow = builder.build_workflow(
                input_data=config["input_data"],
                base_incar=base_incar,
        ...
        elif maker_config.get('class') == HSEUniformBandStructureMaker.__name__:
            custom_maker = HSEUniformBandStructureMaker()
            builder = VASPWorkflowBuilder(custom_maker)
            my_flow = builder.build_workflow(
                input_data=config["input_data"],
                base_incar=base_incar,
        ...
        elif maker_config.get('class') == LineModeBandStructureMaker.__name__:
            custom_maker = LineModeBandStructureMaker()
            builder = VASPWorkflowBuilder(custom_maker)
            my_flow = builder.build_workflow(
                input_data=config["input_data"],
                base_incar=base_incar,
        ...
        elif maker_config.get('class') == OpticsMaker.__name__:
            custom_maker = HSEOpticsMaker()
            builder = VASPWorkflowBuilder(custom_maker)
            my_flow = builder.build_workflow(
                input_data=config["input_data"],
        ...
        elif maker_config.get('class') == RelaxBandStructureMaker.__name__:
            custom_maker = RelaxBandStructureMaker()
            builder = VASPWorkflowBuilder(custom_maker)
            my_flow = builder.build_workflow(
                input_data=config["input_data"],
                base_incar=base_incar,
        ...
        elif maker_config.get('class') == UniformBandStructureMaker.__name__:
            custom_maker = UniformBandStructureMaker()
            builder = VASPWorkflowBuilder(custom_maker)
            my_flow = builder.build_workflow(
                input_data=config["input_data"],
                base_incar=base_incar,
